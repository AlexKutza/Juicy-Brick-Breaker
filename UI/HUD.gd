...
var indicator_mod_target = 0.3
var indicator_scale = Vector2(0.2,0.2)
var indicator_scale_start = Vector2(0.1,0.1)
var indicator_scale_target = Vector2(0.2,0.2)
...
func breathe():
	...
	for i in $Indicator_Container.get_children():
		tween.tween_property(i.get_node("Highlight"), "scale", indicator_scale, 0.8)
		tween.tween_property(i.get_node("Highlight"), "modulate:a", indicator_mod, 0.8)
